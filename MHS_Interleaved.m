function [BestGen,BestFitness,gx]=MHS_Interleaved(A,UB,LB,HMS,truelabels)  
...
%             end
          UpdateHM( srrcost,interleaved );
                        ...
                        %             title('hyperdization K-means+HS')
                        %             xlabel('Iterations')
       ...
       writetable(T,'C:\Users\32599642\Desktop\MHS_Interleaved.xls');
    end 
