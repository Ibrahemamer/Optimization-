%%DHS
function FuzzyDHS(A,UB,LB,HMS, truelabels)
...
options = [1.1 NaN NaN 0];  %[ (1)the amount of fuzzy overlap between clusters, (2)Maximum number of iterations, 
% %(3)Minimum improvement in objective function between two consecutive iterations,  (4) display info]
[center,U,obj_fcn] = fcm(A, UB-1,options);
  interleaved = functionKmeans(A, center, UB-1);
